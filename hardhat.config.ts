...
const TASK_FOLDERS = ["misc", "market-registry", "atokens"];
...
export default {
  ...
  networks: {
    ...
    tenderly: getCommonNetworkConfig("tenderly", 42161),
  ...
  dependencyCompiler: {
    paths: [
      ...
      "@mahalend/periphery/contracts/rewards/transfer-strategies/SimpleRewardsTransferStrategy.sol",
      "@mahalend/periphery/contracts/rewards/transfer-strategies/SimpleRewardsTransferStrategy.sol",
      "@mahalend/core/contracts/protocol/tokenization/MasterchefAToken.sol",
      "@mahalend/core/contracts/dependencies/openzeppelin/contracts/Ownable.sol",
    ],
  },
