...
export const EMISSION_MANAGER_ID = "EmissionManagerV2";
export const INCENTIVES_V2_IMPL_ID = `IncentivesV3-${IMPL_ID}`;
export const INCENTIVES_PULL_REWARDS_STRATEGY_ID = `PullRewardsTransferStrategyV2`;
export const INCENTIVES_SIMPLE_REWARDS_STRATEGY_ID = `SimpleRewardsTransferStrategyV2`;
