...
import { EMPTY_STORAGE_SLOT, V3_PERIPHERY_VERSION } from "../../helpers/constants";
import { EMISSION_MANAGER_ID, INCENTIVES_PROXY_ID, INCENTIVES_PULL_REWARDS_STRATEGY_ID, INCENTIVES_STAKED_TOKEN_STRATEGY_ID, INCENTIVES_V2_IMPL_ID, STAKE_AAVE_PROXY } from "../../helpers/deploy-ids";
import { COMMON_DEPLOY_PARAMS, MARKET_NAME } from "../../helpers/env";
import { ConfigNames, getParamPerNetwork, loadPoolConfig } from "../../helpers/market-config-helpers";
...
const func: DeployFunction = async function ({ getNamedAccounts, deployments, ...hre }: HardhatRuntimeEnvironment) {
    ...
    if (proxyAdminSlot === EMPTY_STORAGE_SLOT) {
        ...
        await waitForTx(await incentivesImpl.initialize(emissionManagerArtifact.address));
        // Initialize proxy
