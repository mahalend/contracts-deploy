...
import { TREASURY_CONTROLLER_ID, TREASURY_IMPL_ID, TREASURY_PROXY_ID } from "../../helpers/deploy-ids";
...
const func: DeployFunction = async function ({ getNamedAccounts, deployments, ...hre }: HardhatRuntimeEnvironment) {
    ...
    await waitForTx(await proxy["initialize(address,address,bytes)"](treasuryImplArtifact.address, treasuryProxyAdmin, initializePayload));
