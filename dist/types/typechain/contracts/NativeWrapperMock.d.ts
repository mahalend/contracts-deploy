...
export interface NativeWrapperMockInterface extends utils.Interface {
    functions: {
...
export interface NativeWrapperMock extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: NativeWrapperMockInterface;
