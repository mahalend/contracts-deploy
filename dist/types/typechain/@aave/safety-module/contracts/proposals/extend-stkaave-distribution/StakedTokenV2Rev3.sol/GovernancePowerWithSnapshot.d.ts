...
export interface GovernancePowerWithSnapshotInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "DELEGATE_BY_TYPE_TYPEHASH" | "DELEGATE_TYPEHASH" | "_aaveGovernance" | "_votingSnapshots" | "_votingSnapshotsCounts" | "allowance" | "approve" | "balanceOf" | "decimals" | "decreaseAllowance" | "delegate" | "delegateByType" | "getDelegateeByType" | "getPowerAtBlock" | "getPowerCurrent" | "increaseAllowance" | "name" | "symbol" | "totalSupply" | "totalSupplyAt" | "transfer" | "transferFrom"): FunctionFragment;
