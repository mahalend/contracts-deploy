...
export interface CollectorInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "REVISION" | "approve" | "getFundsAdmin" | "initialize" | "setFundsAdmin" | "transfer"): FunctionFragment;
...
export interface Collector extends BaseContract {
    ...
    functions: {
        ...
        initialize(reserveController: PromiseOrValue<string>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        getFundsAdmin(overrides?: CallOverrides): Promise<string>;
        initialize(reserveController: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>;
