...
export interface AdminControlledEcosystemReserveInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "ETH_MOCK_ADDRESS" | "REVISION" | "approve" | "getFundsAdmin" | "transfer"): FunctionFragment;
