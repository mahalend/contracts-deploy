...
export interface ParaSwapLiquiditySwapAdapterInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "ADDRESSES_PROVIDER" | "AUGUSTUS_REGISTRY" | "MAX_SLIPPAGE_PERCENT" | "ORACLE" | "POOL" | "executeOperation" | "owner" | "renounceOwnership" | "rescueTokens" | "swapAndDeposit" | "transferOwnership"): FunctionFragment;
...
export interface ParaSwapLiquiditySwapAdapter extends BaseContract {
    ...
    functions: {
        ...
        swapAndDeposit(assetToSwapFrom: PromiseOrValue<string>, assetToSwapTo: PromiseOrValue<string>, amountToSwap: PromiseOrValue<BigNumberish>, minAmountToReceive: PromiseOrValue<BigNumberish>, swapAllBalanceOffset: PromiseOrValue<BigNumberish>, swapCalldata: PromiseOrValue<BytesLike>, augustus: PromiseOrValue<string>, permitParams: BaseParaSwapAdapter.PermitSignatureStruct, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        swapAndDeposit(assetToSwapFrom: PromiseOrValue<string>, assetToSwapTo: PromiseOrValue<string>, amountToSwap: PromiseOrValue<BigNumberish>, minAmountToReceive: PromiseOrValue<BigNumberish>, swapAllBalanceOffset: PromiseOrValue<BigNumberish>, swapCalldata: PromiseOrValue<BytesLike>, augustus: PromiseOrValue<string>, permitParams: BaseParaSwapAdapter.PermitSignatureStruct, overrides?: CallOverrides): Promise<void>;
