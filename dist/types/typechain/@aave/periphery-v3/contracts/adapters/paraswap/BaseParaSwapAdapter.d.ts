...
export interface BaseParaSwapAdapterInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "ADDRESSES_PROVIDER" | "MAX_SLIPPAGE_PERCENT" | "ORACLE" | "POOL" | "executeOperation" | "owner" | "renounceOwnership" | "rescueTokens" | "transferOwnership"): FunctionFragment;
