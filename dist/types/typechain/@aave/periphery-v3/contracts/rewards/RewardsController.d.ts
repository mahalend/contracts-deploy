...
export interface RewardsControllerInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "REVISION" | "claimAllRewards" | "claimAllRewardsOnBehalf" | "claimAllRewardsToSelf" | "claimRewards" | "claimRewardsOnBehalf" | "claimRewardsToSelf" | "configureAssets" | "getAllUserRewards" | "getAssetDecimals" | "getAssetIndex" | "getClaimer" | "getDistributionEnd" | "getEmissionManager" | "getRewardOracle" | "getRewardsByAsset" | "getRewardsData" | "getRewardsList" | "getTransferStrategy" | "getUserAccruedRewards" | "getUserAssetIndex" | "getUserRewards" | "handleAction" | "initialize" | "setClaimer" | "setDistributionEnd" | "setEmissionManager" | "setEmissionPerSecond" | "setRewardOracle" | "setTransferStrategy"): FunctionFragment;
...
export interface RewardsController extends BaseContract {
    ...
    functions: {
        ...
        initialize(emissionManager: PromiseOrValue<string>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        initialize(emissionManager: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>;
