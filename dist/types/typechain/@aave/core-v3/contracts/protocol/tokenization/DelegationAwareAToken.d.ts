...
export interface DelegationAwareATokenInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "ATOKEN_REVISION" | "DOMAIN_SEPARATOR" | "EIP712_REVISION" | "PERMIT_TYPEHASH" | "POOL" | "RESERVE_TREASURY_ADDRESS" | "UNDERLYING_ASSET_ADDRESS" | "allowance" | "approve" | "balanceOf" | "burn" | "decimals" | "decreaseAllowance" | "delegateUnderlyingTo" | "getIncentivesController" | "getPreviousIndex" | "getScaledUserBalanceAndSupply" | "handleRepayment" | "increaseAllowance" | "initialize" | "mint" | "mintToTreasury" | "name" | "nonces" | "permit" | "rescueTokens" | "scaledBalanceOf" | "scaledTotalSupply" | "setIncentivesController" | "symbol" | "totalSupply" | "transfer" | "transferFrom" | "transferOnLiquidation" | "transferUnderlyingTo"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "delegateUnderlyingTo", values: [PromiseOrValue<string>]): string;
    ...
    decodeFunctionResult(functionFragment: "delegateUnderlyingTo", data: BytesLike): Result;
...
export type DelegateUnderlyingToEventFilter = TypedEventFilter<DelegateUnderlyingToEvent>;
...
export interface DelegationAwareAToken extends BaseContract {
    ...
    functions: {
        ...
        delegateUnderlyingTo(delegatee: PromiseOrValue<string>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        delegateUnderlyingTo(delegatee: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>;
        getIncentivesController(overrides?: CallOverrides): Promise<string>;
        getPreviousIndex(user: PromiseOrValue<string>, overrides?: CallOverrides): Promise<BigNumber>;
        getScaledUserBalanceAndSupply(user: PromiseOrValue<string>, overrides?: CallOverrides): Promise<[BigNumber, BigNumber]>;
    ...
    filters: {
        ...
        "DelegateUnderlyingTo(address)"(delegatee?: PromiseOrValue<string> | null): DelegateUnderlyingToEventFilter;
        DelegateUnderlyingTo(delegatee?: PromiseOrValue<string> | null): DelegateUnderlyingToEventFilter;
