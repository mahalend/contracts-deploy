...
export interface VariableDebtTokenInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "DEBT_TOKEN_REVISION" | "DELEGATION_WITH_SIG_TYPEHASH" | "DOMAIN_SEPARATOR" | "EIP712_REVISION" | "POOL" | "UNDERLYING_ASSET_ADDRESS" | "allowance" | "approve" | "approveDelegation" | "balanceOf" | "borrowAllowance" | "burn" | "decimals" | "decreaseAllowance" | "delegationWithSig" | "getIncentivesController" | "getPreviousIndex" | "getScaledUserBalanceAndSupply" | "increaseAllowance" | "initialize" | "mint" | "name" | "nonces" | "scaledBalanceOf" | "scaledTotalSupply" | "setIncentivesController" | "symbol" | "totalSupply" | "transfer" | "transferFrom"): FunctionFragment;
