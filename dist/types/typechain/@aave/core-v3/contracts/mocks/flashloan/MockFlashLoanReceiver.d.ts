...
export interface MockFlashLoanReceiver extends BaseContract {
    ...
    functions: {
        ...
        executeOperation(assets: PromiseOrValue<string>[], amounts: PromiseOrValue<BigNumberish>[], premiums: PromiseOrValue<BigNumberish>[], arg3: PromiseOrValue<string>, arg4: PromiseOrValue<BytesLike>, overrides?: Overrides & {
    ...
    callStatic: {
        ADDRESSES_PROVIDER(overrides?: CallOverrides): Promise<string>;
        POOL(overrides?: CallOverrides): Promise<string>;
        executeOperation(assets: PromiseOrValue<string>[], amounts: PromiseOrValue<BigNumberish>[], premiums: PromiseOrValue<BigNumberish>[], arg3: PromiseOrValue<string>, arg4: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<boolean>;
        getAmountToApprove(overrides?: CallOverrides): Promise<BigNumber>;
    ...
    filters: {
        "ExecutedWithFail(address[],uint256[],uint256[])"(_assets?: null, _amounts?: null, _premiums?: null): ExecutedWithFailEventFilter;
        ExecutedWithFail(_assets?: null, _amounts?: null, _premiums?: null): ExecutedWithFailEventFilter;
        "ExecutedWithSuccess(address[],uint256[],uint256[])"(_assets?: null, _amounts?: null, _premiums?: null): ExecutedWithSuccessEventFilter;
        ExecutedWithSuccess(_assets?: null, _amounts?: null, _premiums?: null): ExecutedWithSuccessEventFilter;
    };
    estimateGas: {
