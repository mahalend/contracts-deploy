...
export interface MintableERC20Interface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "DOMAIN_SEPARATOR" | "EIP712_REVISION" | "PERMIT_TYPEHASH" | "allowance" | "approve" | "balanceOf" | "decimals" | "decreaseAllowance" | "increaseAllowance" | "mint(address,uint256)" | "mint(uint256)" | "name" | "nonces" | "permit" | "symbol" | "totalSupply" | "transfer" | "transferFrom"): FunctionFragment;
