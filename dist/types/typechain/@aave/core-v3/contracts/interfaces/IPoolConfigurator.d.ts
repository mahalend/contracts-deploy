...
export interface IPoolConfigurator extends BaseContract {
    ...
    functions: {
        ...
        setSiloedBorrowing(asset: PromiseOrValue<string>, siloed: PromiseOrValue<boolean>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        setSiloedBorrowing(asset: PromiseOrValue<string>, siloed: PromiseOrValue<boolean>, overrides?: CallOverrides): Promise<void>;
