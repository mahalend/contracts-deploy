...
export interface InitializableAdminUpgradeabilityProxy extends BaseContract {
    ...
    functions: {
        ...
        "initialize(address,address,bytes)"(logic: PromiseOrValue<string>, admin: PromiseOrValue<string>, data: PromiseOrValue<BytesLike>, overrides?: PayableOverrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        "initialize(address,address,bytes)"(logic: PromiseOrValue<string>, admin: PromiseOrValue<string>, data: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<void>;
