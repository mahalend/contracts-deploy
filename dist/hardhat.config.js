...
exports.default = {
  ...
  networks: {
    ...
    tenderly: (0, hardhat_config_helpers_1.getCommonNetworkConfig)(
      "tenderly",
      3030
    ),
    main: (0, hardhat_config_helpers_1.getCommonNetworkConfig)(
      types_1.eEthereumNetwork.main,
      1
    ),
    kovan: (0, hardhat_config_helpers_1.getCommonNetworkConfig)(
      types_1.eEthereumNetwork.kovan,
      42
    ),
    rinkeby: (0, hardhat_config_helpers_1.getCommonNetworkConfig)(
      types_1.eEthereumNetwork.rinkeby,
      4
    ),
    ropsten: (0, hardhat_config_helpers_1.getCommonNetworkConfig)(
      types_1.eEthereumNetwork.ropsten,
      3
    ),
    [types_1.ePolygonNetwork.polygon]: (0,
    hardhat_config_helpers_1.getCommonNetworkConfig)(
      types_1.ePolygonNetwork.polygon,
      137
    ),
    [types_1.ePolygonNetwork.mumbai]: (0,
    hardhat_config_helpers_1.getCommonNetworkConfig)(
      types_1.ePolygonNetwork.mumbai,
      80001
    ),
    arbitrum: (0, hardhat_config_helpers_1.getCommonNetworkConfig)(
      types_1.eArbitrumNetwork.arbitrum,
      42161
    ),
    [types_1.eArbitrumNetwork.arbitrumTestnet]: (0,
    hardhat_config_helpers_1.getCommonNetworkConfig)(
      types_1.eArbitrumNetwork.arbitrumTestnet,
      421611
    ),
    [types_1.eHarmonyNetwork.main]: (0,
    hardhat_config_helpers_1.getCommonNetworkConfig)(
      types_1.eHarmonyNetwork.main,
      1666600000
    ),
    [types_1.eHarmonyNetwork.testnet]: (0,
    hardhat_config_helpers_1.getCommonNetworkConfig)(
      types_1.eHarmonyNetwork.testnet,
      1666700000
    ),
    [types_1.eAvalancheNetwork.avalanche]: (0,
    hardhat_config_helpers_1.getCommonNetworkConfig)(
      types_1.eAvalancheNetwork.avalanche,
      43114
    ),
    [types_1.eAvalancheNetwork.fuji]: (0,
    hardhat_config_helpers_1.getCommonNetworkConfig)(
      types_1.eAvalancheNetwork.fuji,
      43113
    ),
    [types_1.eFantomNetwork.main]: (0,
    hardhat_config_helpers_1.getCommonNetworkConfig)(
      types_1.eFantomNetwork.main,
      250
    ),
    [types_1.eFantomNetwork.testnet]: (0,
    hardhat_config_helpers_1.getCommonNetworkConfig)(
      types_1.eFantomNetwork.testnet,
      4002
    ),
    [types_1.eOptimismNetwork.testnet]: (0,
    hardhat_config_helpers_1.getCommonNetworkConfig)(
      types_1.eOptimismNetwork.testnet,
      420
    ),
    [types_1.eOptimismNetwork.main]: (0,
    hardhat_config_helpers_1.getCommonNetworkConfig)(
      types_1.eOptimismNetwork.main,
      10
    ),
    [types_1.eEthereumNetwork.görli]: (0,
    hardhat_config_helpers_1.getCommonNetworkConfig)(
      types_1.eEthereumNetwork.görli,
      5
    ),
    [types_1.eArbitrumNetwork.görliNitro]: (0,
    hardhat_config_helpers_1.getCommonNetworkConfig)(
